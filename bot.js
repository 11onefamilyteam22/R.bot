...
const yt = require('ytdl-core');
  if (message.content.startsWith('t!quran')) {
  ...
  if (message.content.startsWith('t!stop')) {
              if(!message.channel.guild) return message.reply('** This command only for servers **');
...
client.on('message', message => {
    if (message.content.startsWith ("t!invites")) {
     if(!message.channel.guild) return message.reply('** This command only for servers **');
...
client.on('message', message => {
if(message.content.startsWith('t!discrim') ) {
     if(!message.channel.guild) return message.reply('** This command only for servers **')
...
//bc online
  ...
  client.on("message", message => {
              ...
              if (message.content.startsWith(prefix + "t!bc")) {
                           if (!message.member.hasPermission("ADMINISTRATOR"))  return;
    let args = message.content.split(" ").slice(1);
    var argresult = args.join(' ');
  ...
  client.on('message', message => {
      ...
      if (message.content.startsWith("t! رابط")) {
  ...
  client.on('message', msg => {
    if (msg.content.startsWith(`t!warn`)) {
